# count
# NOTE: This exercise was originally a duplicate from the
# previous exercise set. We have modified it slightly, but some
# of the posted solutions still reflect the original wording.

# The Enumerable#count method iterates over the members of a
# collection, passing each element to the associated block. It
# then returns the number of elements for which the block returns
# a truthy value.

# Write a method called count that behaves similarly for an
# arbitrarily long list of arguments. It should take 0 or more
# arguments and a block, and then return the total number of
# arguments for which the block returns true.
